...
export default function LinkItem({ id, label, url }: LinkItemProps) {
    ...
    return (
        <a
            ...
            className="group flex items-center w-full bg-white hover:bg-brand-pearl/50 border border-brand-gold/20 hover:border-brand-gold/40 rounded-2xl p-4 transition-all duration-300 hover:shadow-lg active:scale-95 min-h-[56px]"
        >
